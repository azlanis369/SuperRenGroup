...
function adminProfile(user: UserRow): AgentProfileRow {
  ...
  return {
    id: `profile-${user.id}`,
    user_id: user.id,
    full_name: isSuper ? "Super Admin" : "Pentadbir SuperRen",
    display_name: isSuper ? "Super Admin" : "Pentadbir SuperRen",
    slug: isSuper ? "super-admin" : "pentadbir",
    profile_photo_url: null,
    ren_number: null,
    agency_name: "Chester Properties HQ",
    title: isSuper ? "Super Admin" : "Admin Sokongan",
    phone: "+60 12-000 0000",
    whatsapp: "+60120000000",
    email: user.email,
    bio: isSuper ? "Akaun pentadbir demo." : "Akaun admin sokongan SuperRen.",
    service_areas: [],
    specialization: [],
    facebook_url: null,
    instagram_url: null,
