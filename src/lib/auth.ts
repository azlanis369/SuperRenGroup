...
function adminProfile(user: UserRow): AgentProfileRow {
  ...
  return {
    id: `profile-${user.id}`,
    user_id: user.id,
    full_name: isSuper ? "Azlan Zakaria" : "Pentadbir SuperRen",
    display_name: isSuper ? "Azlan Zakaria" : "Pentadbir SuperRen",
    slug: isSuper ? "azlan-zakaria" : "pentadbir",
    profile_photo_url: null,
    ren_number: null,
    agency_name: "Chester Properties HQ",
    title: isSuper ? "System Owner · Super Ren Group" : "Admin Sokongan",
    phone: "+60 12-000 0000",
    whatsapp: "+60120000000",
    email: user.email,
    bio: isSuper
      ? "Pemilik & pentadbir sistem Super Ren Group."
      : "Akaun admin sokongan SuperRen.",
    service_areas: [],
    specialization: [],
    facebook_url: null,
    instagram_url: null,
